...
const CACHE = 'bcc-v4';   /* bumped: new live feeds must never be served from cache */
const SHELL = [
  './',
  'index.html',
...
const LIVE_ONLY = ['tile.openstreetmap.org', 'routing.openstreetmap.de', 'api.open-meteo.com',
                   ...
                   'gopack.com', 'site.api.espn.com', 'wknc.org', 'visibleplanets.dev',
                   'is-birdcast-observed-prod.s3.us-east-1.amazonaws.com'];
